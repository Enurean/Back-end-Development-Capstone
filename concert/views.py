...
def songs(request):
    songs = req.get("http://songs-sn-labs-matiaskgx.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    return render(request, "songs.html", {"songs": songs["songs"]})


def photos(request):
    photos = req.get("https://pictures.15dv9cdl5spw.us-south.codeengine.appdomain.cloud/picture").json()
